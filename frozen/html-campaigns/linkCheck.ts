/**
 * Подсчёт ссылок в письме для мягкой подсказки в мастере кампании (§5.3):
 * не больше одной ссылки в письме — почтовые сервисы
 ...
 * прежнему не в счёт: правило относится к ссылкам, которые пишет сам
