export const demoCopy = {
  ...
  form: {
    ...
    successText: "Напишем на указанный email и подберём удобное время для короткого демо.",
    done: "Готово",
    ...
    fields: [
      ...
      { name: "email", label: "Рабочий email", placeholder: "you@company.ru", autoComplete: "email" },
      { name: "messenger", label: "Telegram (по желанию)", placeholder: "@username", autoComplete: "off" },
      { name: "website", label: "Сайт (по желанию)", placeholder: "https://company.ru", autoComplete: "url" },
    ],
    loading: "Отправляем…",
